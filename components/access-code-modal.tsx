...
export function AccessCodeModal({ isOpen, onClose, onSuccess }: AccessCodeModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <Card className="relative w-full sm:max-w-md p-4 sm:p-6 shadow-2xl border-2 border-primary/20 rounded-t-2xl sm:rounded-2xl" style={{ maxHeight: 'min(90vh, calc(100dvh - env(safe-area-inset-top) - env(safe-area-inset-bottom) - 20px))', paddingBottom: 'max(1.5rem, env(safe-area-inset-bottom))' }}>
        {/* Close Button */}
        <Button
          variant="ghost"
          size="sm"
